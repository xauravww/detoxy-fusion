...
const Profile = () => {
  ...
  if (loading) {
    return <div className="flex justify-center items-center h-screen text-white"><HamsterLoader /></div>;
  }
  ...
  return (
    <div className="min-h-[calc(100vh-13vh)] md:min-h-[calc(100vh-13vh)] lg:min-h-[calc(100vh-12vh)] flex flex-col items-center justify-center bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white">
